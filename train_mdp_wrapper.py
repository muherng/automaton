...
from train_mdp import train_on_data
...
if __name__ == "__main__":
    ...
    for states in [16]: 
        for iterations in [1]:
            for discount in np.arange(0.5,1,0.1).tolist(): 
    ...
    #path_to_pretrain = directory + f'/{args.seq}_{args.kind}s16i1.pth' 
    ...
    for i in range(len(my_args)):
        ...
        path_to_pretrain = directory + f'/{args.seq}_{args.kind}s{args.states}i{args.iterations}.pth' 